...
<div class="page container-sm" id='entrySection' style="display: none;">
    <form method="POST" class="formCadastro" action="/controllers/classSupplier.php">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="inputinvoice" placeholder="Nota Fiscal" name="invoice"
        ...
        <!-- Data de Emissão -->
        <div class="form-floating mb-3">
            <input type="date" class="form-control" id="inputDataEmissao" placeholder="Data de Emissão"
        ...
        <!-- CNPJ do Fornecedor -->
        <div class="form-floating mb-3">
            <input type="text" class="form-control mt-3" id="inputCnpjFornecedor" placeholder="CNPJ do Fornecedor"
                name="cnpjFornecedor" maxlength="14" required>
            <label for="inputCnpjFornecedor">CNPJ do Fornecedor:</label>
        </div>

        <!-- Logradouro -->
        <div class="form-floating mb-3">
            <input type="text" class="form-control mt-3" id="inputLogradouro" placeholder="Logradouro" name="Logradouro"
                required>
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control mt-3" id="inputCEP" placeholder="CEP" name="cep" maxlength="8"
                required>
