...
<div class="page container-sm" id='entrySection' style="display: none;">
    <form method="POST" class="formCadastro" action="/views/register/registerItem.php">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control mt-3" id="inputEnderecoFornecedor" placeholder="Endereço do Fornecedor" name="enderecoFornecedor" required>
            <label for="inputEnderecoFornecedor">Endereço do Fornecedor:</label>
        </div>        
